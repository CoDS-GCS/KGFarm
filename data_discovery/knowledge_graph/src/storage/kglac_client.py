...
class KGLacClient:
    ...
    def predict_entities_and_feature_views(self, thresh=0.70, show_query=False):
        query = queryTemplates.predict_entities_and_feature_views(thresh)
        if show_query:
            _print_query(query)
            ...
            for i in range(2, h + 1):
                inter = '\n    ?c' + str(i) + ' a lac:column.' \
                                              '\n    ?c' + str(i) + ' schema:name ?c' + str(i) + 'name.' \
                                                                                                 '\n    ?c' + str(
                    i) + ' dct:isPartOf ?t' + str(i) + '.' \
                                                       '\n    ?t' + str(i) + ' schema:name ?t' + str(i) + 'name.' \
                                                                                                          '\n    ?t' + str(
                    i) + ' lac:path ?t' + str(i) + 'path.' \

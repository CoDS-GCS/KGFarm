...
def get_column_emb(entity_df, name):
    ...
    file1 = pd.read_csv('operations/storage/'+name+'_gnn_Table/mapping/Column_entidx2name.csv')
...
def graphSaint(dataset_to_clean, dataset_name_script):
    ...
    if loadTrainedModel == 1:
        with torch.no_grad():
            ...
            api.download_registry_model("nikimonjazeb", "cleaning", version=None, output_path="operations/Models/", expand=True, stage=None)

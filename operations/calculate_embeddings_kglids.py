...
from .utils.column_embeddings import load_numeric_embedding_model, load_string_embedding_model, \
    load_nl_embedding_model
from .utils.fine_grained_type_detector import FineGrainedColumnTypeDetector
from .utils.column_data_type import ColumnDataType

class EmbeddingCreator:
    def __init__(self):
        # load CoLR Embedding models
        self.int_embedding_model = load_numeric_embedding_model(
            path='operations/Models/kglids_models/int/20230123140419_int_model_embedding_epoch_100.pt')
        self.float_embedding_model = load_numeric_embedding_model(
            path='operations/Models/kglids_models/float/20230124151732_float_model_embedding_epoch_89.pt')
        self.date_embedding_model = load_numeric_embedding_model(
            path='operations/Models/kglids_models/date/20230113111008_date_model_embedding_epoch_100.pt')
        self.named_entity_embedding_model = load_nl_embedding_model(
            path='operations/Models/kglids_models/named_entity/20230125181821_named_entity_model_embedding_epoch_34.pt')
        self.natural_language_text_embedding_model = load_nl_embedding_model(
            path='operations/Models/kglids_models/natural_language_text/20230113132355_natural_language_text_model_embedding_epoch_94.pt')
        self.string_embedding_model = load_string_embedding_model(
            path='operations/Models/kglids_models/string/20230111150300_string_model_embedding_epoch_100.pt')
    ...
    def new_emb(self, entity_df: pd.DataFrame, operation):
        ...
        def preprocess_nl(column):
            ...
            fasttext_model = compress_fasttext.models.CompressedFastTextKeyedVectors.load(
                'operations/utils/ft_cc.en.50.bin')

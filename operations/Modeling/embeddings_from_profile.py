...
def get_profiles(graph_name):
    metadata = 'operations/storage/profiles/' + graph_name
...
def get_table_embeddings_scaling(graph_name):
    ...
    file_path = "operations/storage/Embeddings_tables_"+graph_name+".csv"
...
def get_column_embeddings(graph_name):
    ...
    file_path = 'operations/storage/Embeddings_columns_' + graph_name + '.csv'

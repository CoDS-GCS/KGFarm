...
def create_encoding_file(graph_name: str='cleaning_graph', operation: str='cleaning'):
    ...
    df = pd.read_csv('operations/storage/output_' + graph_name + '.csv', quotechar='"')#"output_cleaning_w_extras_profiles_comp.csv"
    ...
    df_type_out.to_csv("operations/storage/output_" + graph_name + "_type.csv", index=False)
    df_out.to_csv("operations/storage/output_" + graph_name + "_file.csv", index=False)

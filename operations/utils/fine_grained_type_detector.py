...
class FineGrainedColumnTypeDetector:
    stanford_ner_model = "operations/utils/english.muc.7class.distsim.crf.ser.gz"
    stanford_jar_file = "operations/utils/stanford-ner.jar"
    ner_tagger = StanfordNERTagger(stanford_ner_model, stanford_jar_file)
    fasttext_model = compress_fasttext.models.CompressedFastTextKeyedVectors.load('operations/utils/ft_cc.en.50.bin')

...
def get_column_emb(dataset_name_script,df_train):
    ...
    file1 = pd.read_csv('operations/storage/'+dataset_name_script+'_gnn_Table/mapping/Column_entidx2name.csv')
    ...
    if loadTrainedModel == 1:
        with torch.no_grad():
            ...
            model.load_state_dict(torch.load(
                "operations/Models/kgfarm_gnn_GA_0_DBLP_conf_GSAINT_QM_e30_r3_s30_l1_hc128_w4_lr10_drop5_new_emb_1800.model"))

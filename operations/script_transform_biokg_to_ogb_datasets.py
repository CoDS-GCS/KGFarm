...
def triplet_encoding(dataset_name_script,label_node):
    ...
    dataset_name_csv = "operations/storage/output_file_"+dataset_name_script+".csv"
    dataset_types = "operations/storage/output_type_"+dataset_name_script+".csv"
    split_by = {"folder_name": "random"}
    target_rel="http://kglids.org/ontology/pipeline/HasCleaningOperation"
    dic_results = {}
    Literals2Nodes = True
    output_root_path = "operations/storage/"

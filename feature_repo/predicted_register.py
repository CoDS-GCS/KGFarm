...
client_completedclient = Entity(name='client_completedclient', value_type=ValueType.STRING, join_key='client_id')
...
loan_luxuryloanportfolio = Entity(name='loan_luxuryloanportfolio', value_type=ValueType.STRING, join_key='social')
